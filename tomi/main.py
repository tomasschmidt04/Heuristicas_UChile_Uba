...
# ---------------------------
def build_initial_solution(graph, workers, depot=0, strategy='mixed'):
    """
...
def nearest_neighbor_variants(graph, meet_points, all_dist, depot=0, variant='random'):
    ...
    """
    return nearest_neighbor_greedy(graph, meet_points, all_dist, depot)
...
if __name__ == "__main__":
    ...
    # fase de construcción: elegir puntos de encuentro
    #Ci, meet_points, all_dist = build_initial_solution_improved(graph, workers, depot=0, strategy='mixed')
    # fase de construcción: ruta inicial con Nearest Neighbor aleatorizado
    #initial_route = nearest_neighbor_random(meet_points, all_dist, depot=0, k=3)
    #initial_cost = route_cost(initial_route, all_dist)
